...
package org.owwlo.Blokus.Shared;
...
public final class GameApi {
    ...
    public static class VerifyMove extends Message {
        ...
        public List<Object> getFieldsNameAndValue() {
            return Arrays.<Object> asList(
                    ...
                    "lastState", lastState, "lastMove", lastMove, "lastMovePlayerId",
                    lastMovePlayerId,
    ...
    public static class AttemptChangeTokens extends Operation {
         ...
         * in the pot (in playerIdToNumberOfTokensInPot). For example, suppose
         * the total pot is initially empty, i.e.,
         ...
         * operation succeeded. As the game continues, playerId=43 might risk
         * more money: AttemptChangeTokens({43: -3000}, {42: 3000, 43: 5000})
         * and if he has enough tokens then the total pot will increase to 8000:
         * playerIdToNumberOfTokensInPot={42: 3000, 43: 5000} When the game ends
         * you should distribute the pot, e.g., if the game ends in a tie you
         * could call: AttemptChangeTokens({42: 4000, 43: 4000}, {42: 0, 43:0})
         * and then the total pot will be 0. If the game ends when the total pot
         * is non-zero, the pot is given to the player with the highest score
         * (see {@link EndGame}).
         */
